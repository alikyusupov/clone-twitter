import { Bookmark, MoreVert } from '@material-ui/icons'
        ...
        <div className='post'>
            <div className='postWrapper'>
                <div className='postTop'>
                    <div className='postTopLeft'>
                        <Link to={`profile/${post.authorID}`}>
                            <img src={post.avatarURL || PF + "/person/noAvatar.png"} alt='' className='postProfileImg'></img>
                        </Link>
                        <span className='postUsername'>{post.name}</span>
                        <span className='postDate'>{format(post.createdAt)||"N/A"}</span>
                    </div>
                ...
                <div className='postCenter'>
                    ...
                    <img className='postImg' src={post.imagePath} alt=''></img>
                </div>
